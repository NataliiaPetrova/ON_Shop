CREATE   PROCEDURE [Master].[SP_Cities]
as
...
IF NOT EXISTS (SELECT TOP (1) CityID FROM master.Cities)
BEGIN
BULK INSERT MASTER.Cities
FROM  'C:\Users\npetrov\source\repos\OnShop\Inserts\Cities.csv'
WITH (FIRSTROW = 2,
    FIELDTERMINATOR = ',',
	ROWTERMINATOR='\n' )
